...
archivo1 <- "genes_seleccionados_positivos_PAAD_CBP_nombres.csv"
archivo2 <- "datos_PAAD_GEPIA_overexpressed_csv.csv"
output_file <- "genes_comunes_positivos_PAAD.csv"
