...
write.csv(genes_csv, "genes_seleccionados_negativos_STAD_CBP.csv", row.names = FALSE)

# Paso 5: Leer el archivo creado y buscar nombres de genes en NCBI
archivo_genes <- "genes_seleccionados_negativos_STAD_CBP.csv"
...
write.csv(resultado_final, "genes_seleccionados_negativos_STAD_CBP_nombres.csv", row.names = FALSE)

print("Proceso completado. Archivo 'genes_seleccionados_negativos_STAD_CBP_nombres.csv' creado.")
