rm(list=ls())
setwd("~/MASTER/TESIS/codigo_SKCM")
...
archivo <- "datos_SKCM_CBP_csv.csv"
...
write.csv(genes_csv, "genes_seleccionados_positivos_SKCM_CBP.csv", row.names = FALSE)

# Paso 5: Leer el archivo creado y buscar nombres de genes en NCBI
archivo_genes <- "genes_seleccionados_positivos_SKCM_CBP.csv"
...
write.csv(resultado_final, "genes_seleccionados_positivos_SKCM_CBP_nombres.csv", row.names = FALSE)

print("Proceso completado. Archivo 'genes_seleccionados_positivos_SKCM_CBP_nombres.csv' creado.")