...
archivo_geneid <- "genes_seleccionados_negativos_LUAD_CBP.csv"  # Archivo con la columna GeneID
archivo_hugo <- "datos_Hugo_Symbol_LUAD_CBP.csv"      # Archivo con las columnas Hugo_Symbol y Entrez_Gene_ID
archivo_salida <- "genes_seleccionados_negativos_LUAD_CBP_nombres.csv"       # Nombre del archivo de salida
