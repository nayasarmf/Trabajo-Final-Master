rm(list=ls())
setwd("~/MASTER/TESIS/comparacion_LUAD")
...
archivo1 <- "genes_seleccionados_negativos_LUAD_CBP_nombres.csv"
archivo2 <- "datos_LUAD_GEPIA_underexpressed_csv.csv"
output_file <- "genes_comunes_negativos_LUAD.csv"
