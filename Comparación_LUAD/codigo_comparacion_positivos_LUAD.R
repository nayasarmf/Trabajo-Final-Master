...
archivo1 <- "genes_seleccionados_positivos_LUAD_CBP_nombres.csv"
archivo2 <- "datos_LUAD_GEPIA_overexpressed_csv.csv"
output_file <- "genes_comunes_positivos_LUAD.csv"
