...
archivo1 <- "genes_seleccionados_positivos_SKCM_CBP_nombres.csv"
archivo2 <- "datos_SKCM_GEPIA_overexpressed_csv.csv"
output_file <- "genes_comunes_positivos_SKCM.csv"
