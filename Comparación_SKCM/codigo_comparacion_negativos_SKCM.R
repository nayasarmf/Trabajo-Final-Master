rm(list=ls())
setwd("~/MASTER/TESIS/comparacion_SKCM")
...
archivo1 <- "genes_seleccionados_negativos_SKCM_CBP_nombres.csv"
archivo2 <- "datos_SKCM_GEPIA_underexpressed_csv.csv"
output_file <- "genes_comunes_negativos_SKCM.csv"
