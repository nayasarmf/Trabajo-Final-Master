...
#LLamar la función
archivo1 <- "genes_comunes_negativos_PAAD.csv"
archivo2 <- "datos_PAAD_GEPIA_underexpressed_csv.csv"
archivo_salida <- "genes_comunes_negativos_PAAD_log2FoldChange.csv"
